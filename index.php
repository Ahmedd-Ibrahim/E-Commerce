...
<div class="row">
            ...
            <div class="col-sm-6 col-md-3">
                <div class="thumbnail item-box">
                    ...
                    <div class="caption">
                        ...
                        <span class="add-by">Added By <?php echo getDataById('username', 'users','userId', $item['user_id']) ?></span>
                    </div>
    ...
    ?>
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <?php if (!empty(getItem('all', 'all'))) {
                    foreach (getItem('all', 'all') as $userAds) { ?>
                        <div class="col-sm-6 col-md-3">
                            <div class="thumbnail item-box">
                                ...
                                <div class="caption">
                                    ...
                                    <span class="add-by">Added By <?php echo getDataById('username', 'users','userId', $userAds['user_id']) ?></span>
                                </div>
                            </div>
                        </div>
                    <?php
